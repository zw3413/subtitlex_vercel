    ...
    <>
      ...
      <div className="flex-wrap my-12 max-w-[1000px]">
        ...
        <div className="flex my-4 place-content-center">
          <Image src="/images/icon/hand-down-1-96.png" width={60} height={30}></Image>
          <h2 className="text-4xl my-4 mx-12" >
        ...
        <div className="flex my-4 ">
          ...
          <h1 className="text-xl font-thin mt-20">
             ...
             * if the icon <Image className="inline" src="/images/subtitlex-512-transparent.png" height={30} width={30}></Image> is not showing, please try to reload the page or feedback to us.
            </h1>
          </h1>
        </div>
